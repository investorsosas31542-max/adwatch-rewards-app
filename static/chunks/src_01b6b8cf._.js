...
async function initiateRealTransfer(amountInNaira, details) {
    try {
...
const RewardsProvider = ({ children })=>{
    ...
    const handleAutoTransfer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "RewardsProvider.useCallback[handleAutoTransfer]": async (rewardAmount, details)=>{
...
_s(RewardsProvider, "DO9FSvFizFNxIWaIbR1W3xWO7v4=", false, function() {
    return [
...
//# sourceMappingURL=src_01b6b8cf._.js.map