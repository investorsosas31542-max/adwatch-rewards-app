...
"[project]/src/hooks/use-rewards.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
;
const RewardsContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createContext"])(undefined);
...
const RewardsProvider = ({ children })=>{
    ...
    const [bankDetails, setBankDetails] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [transactions, setTransactions] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    const [transferThreshold, setTransferThreshold] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    const [isInitialized, setIsInitialized] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "RewardsProvider.useEffect": ()=>{
            try {
    ...
    const handleAutoTransfer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "RewardsProvider.useCallback[handleAutoTransfer]": (newBalance)=>{
            if (newBalance > 0 && bankDetails) {
                const amountToTransfer = newBalance;
                const amountInNaira = amountToTransfer * NAIRA_RATE;
                const newTransaction = {
                    id: new Date().toISOString(),
                    amount: amountInNaira,
                    date: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(), "PPp"),
                    status: 'Completed'
                };
                setTransactions({
                    "RewardsProvider.useCallback[handleAutoTransfer]": (prev)=>{
                ...
                }["RewardsProvider.useCallback[handleAutoTransfer]"]);
                toast({
                    title: "⚡ Instant Payout Sent!",
                    description: `₦${amountInNaira.toLocaleString()} has been transferred to your ${bankDetails.bankName} account.`,
                    variant: 'default',
    ...
    const addReward = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "RewardsProvider.useCallback[addReward]": (amount)=>{
            setBalance({
                "RewardsProvider.useCallback[addReward]": (prevBalance)=>{
                    ...
                    handleAutoTransfer(newBalance);
                    return newBalance;
                }
            }["RewardsProvider.useCallback[addReward]"]);
        }
    }["RewardsProvider.useCallback[addReward]"], [
        handleAutoTransfer
    ]);
    ...
    const setTransferThresholdAndSave = (threshold)=>{
        setTransferThreshold(0);
        try {
            localStorage.setItem('adwatch_threshold', JSON.stringify(0));
        } catch (error) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(RewardsContext.Provider, {
        value: {
            balance,
            addReward,
            bankDetails,
            ...
            transactions,
            transferThreshold,
            setTransferThreshold: setTransferThresholdAndSave
        },
        children: children
    }, void 0, false, {
        fileName: "[project]/src/hooks/use-rewards.tsx",
        lineNumber: 132,
        columnNumber: 5
    }, this);
};
_s(RewardsProvider, "V5eMVJfPQE7TB+uhbN38Y05Or/k=", false, function() {
    return [
...
const useRewards = ()=>{
    _s1();
    const context = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(RewardsContext);
    if (context === undefined) {
        throw new Error('useRewards must be used within a RewardsProvider');
    }
    return context;
};
_s1(useRewards, "b9L3QQ+jgeyIrH0NfHrJ8nn7VMU=");
var _c;
__turbopack_context__.k.register(_c, "RewardsProvider");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
function AppHeader() {
    _s();
    const { balance } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$rewards$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRewards"])();
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$badge$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Badge"], {
                            ...
                            style: {
                                backgroundColor: 'hsl(120 73% 75%)',
                                color: 'hsl(120 25% 15%)',
                                borderColor: 'hsl(120 40% 60%)'
                            },
                            children: [
                                "$",
                                balance.toFixed(2)
...
_s(AppHeader, "f0VSOyGTwchaKwvZqz39hm8lALg=", false, function() {
    return [
...
//# sourceMappingURL=src_68c040a9._.js.map